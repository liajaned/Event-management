...
<%@include file="Header.jsp"%>
	...
	<div class="container">
		<div class="row" >
			<div class="col-2"></div>
			<div class="col-8"  style="background-color: teal;">

<h2>MyProfile</h2>
<hr class="border border-primary border-3 opacity-75">
				<h6 style="color: red;"><%=ServletUtility.getErrorMessage(request)%></h6>
				<h6 style="color: green;"><%=ServletUtility.getSuccessMessage(request)%></h6>
				<form action="<%=EM_View.MYPROFILE_CTL%>" method="post">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="lastName" placeholder="Last Name"
								class="form-control" value="<%=DataUtility.getStringData(bean.getLastName())%>">
						</div>
					</div>
					...
					<div class="mb-3" style="width: 75%">
						...
						<div class="form-group">
							<select class="custom-select" name=rolename style="width:75%; height: 40px;">
								<%
